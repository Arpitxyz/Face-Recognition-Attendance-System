...
Absentees Page
--------------
Same as Attendance Log, but shows only students marked Absent.
No Present/Absent buttons.
"""
...
class AbsenteesFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkLabel(header, text="Absentees (Absent Students)",
                     font=("Helvetica", 20, "bold"),
                     text_color="#FF6347").pack(side="left", padx=10)
        ...
        ctk.CTkButton(date_frame, text="Show", width=80,
                      ...
                      command=self.load_absentees).pack(side="left", padx=6)
    ...
    def load_absentees(self):
        """Show students who are registered but not marked Present."""
        ...
        present = {r["student_id"] for r in self.fetch_attendance(date_str)}
        absent_rows = []
    ...
    def export_excel(self):
        ...
        try:
            ...
            messagebox.showinfo("Exported", "Absentees list exported successfully.")
